...
Please report any bugs or suggest improvements. Your contributions are welcome.
...
This project is currently maintained by Nithish Chowdary, a Senior Python Developer and AI/ML Engineer with extensive experience in building scalable backend services and robust command-line tools. Nithish is committed to ensuring the continued development and stability of `git-delete-merged-branches`.

- **GitHub**: [NithishChowdary-Python-Dev](https://github.com/NithishChowdary-Python-Dev)
- **LinkedIn**: [Nithish Chowdary](http://www.linkedin.com/in/nithishchowdary-python)
